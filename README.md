<div align="center"> 
   <h1>DeceasedCraft 项目简体中文翻译</h1>
</div>

| CurseForge     | 加载器     | 整合包版本         | 汉化维护状态 |
| :------------- | :--------- | :----------------- | :----------- |
| [链接](https://www.curseforge.com/minecraft/modpacks/deceasedcraft) | Forge | 1.20.1 5.11.16 | 翻译中       |
...
译者：[查看贡献者排行榜](https://paratranz.cn/projects/15705/leaderboard)
